            ...
            <div class="col-md-5 col-xs-12 go-right">
                <div class="row">
                    <ul class="nav nav-tabs RTL nav-justified">
                        ...
                        <?php } ?>
                        <!-- hotelbeds list item -->
                        <?php  if(pt_module_has_enable('hotelbeds')){ ?>
                        <li role="presentation" class="text-center" data-title="hotelbeds">
                            <a href="#hotelbeds" data-toggle="tab" aria-controls="home" aria-expanded="true">
                                <i class="fa fa-building-o"></i>
                                <div class="visible-xs visible-md clearfix"></div>
                                <span class="hidden-xs"><?php echo trans('Hotel Beds');?></span>
                            </a>
                        </li>
                        <?php } ?>
                        <!-- travelport_hotel list item -->
                        <?php  if(pt_module_has_enable('travelport_hotel')){ ?>
                        <li role="presentation" class="text-center" data-title="travelport_hotel">
                            <a href="#travelport_hotel" data-toggle="tab" aria-controls="home" aria-expanded="true">
                                <i class="fa fa-building-o"></i>
                                <div class="visible-xs visible-md clearfix"></div>
                                <span class="hidden-xs"><?php echo trans('Hotel Port');?></span>
                            </a>
                        </li>
                        <?php } ?>
                    ...
                    <div class="tab-content panel-body">
                        ...
                        <!-- hotelbeds form -->
                        <?php  if(pt_module_has_enable('hotelbeds')){ ?>
                        <div  role="tabpanel" class="tab-pane fade" id="hotelbeds" aria-labelledby="home-tab">
                        ...
                        <?php  if(pt_module_has_enable('travelport_hotel')){ ?>
                        <div  role="tabpanel" class="tab-pane fade" id="travelport_hotel" aria-labelledby="home-tab">
                            <!-- Travelport HotelsSearchFormData pass by home -->
                            <?php echo searchForm('travelport_hotel'); ?>
                        </div>
                        <?php } ?>
