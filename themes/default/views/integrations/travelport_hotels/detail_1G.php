                ...
                <form autocomplete="off" name="hotelRateDetail" action="#" method="GET" role="search">
                    <div style="width:100%">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" placeholder="<?php echo trans('07'); ?>" name="checkin" value="" class="form-control hpcheckin">
                        </div>
                        <div class="form-group col-md-3">
                            <label class="go-right"><?php echo trans('09');?></label>
                            <input type="text" placeholder="<?php echo trans('09'); ?>" name="checkout" value="" class="form-control hpcheckout">
                        </div>
                        <div class="form-group col-md-3">
            ...
            <div class="acc-details__search-results hotelRateDetail">
                <div class="room-cards">
                    <?php if(! empty($hotelDetail->RequestedHotelDetails->HotelRateDetail) ): ?>
                        ...
                        <?php foreach($hotelDetail->RequestedHotelDetails->HotelRateDetail as $room): ?>
                        <div class="room-card">
                                ...
                                <div class="room-card__body">
                                    <div class="room-card__content">
                                        ...
                                        <div class="room-card__content--right">
                                            ...
                                            <form action="<?=base_url('travelport_hotels/hotelApi/reserve')?>" method="post">
...
$(function(){
    $("[name=hotelRateDetail]").on('submit', function(e) {
        ...
        $.get('<?=base_url("travelport_hotels/hotelApi/rateAndRule")?>', payload, function(resp) {
