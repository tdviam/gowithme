...
<div class="container offset-0">
  ...
  <?php if(!$ismobile): ?>
    <div class="col-md-3 hidden-sm hidden-xs" style="background: #f2f2f2;padding-bottom:15px">
      <!-- FILTERS -->
      <form action="<?php echo base_url('hotelbeds/search/filter'); ?>" method="GET" role="search">
            ...
            <div class="col-md-8 col-xs-7 g0-left">
              <div class="row">
                <h4 class="RTL go-text-right mt0 list_title">
                    <a href="#"><b><?= $hotel->name ?></b></a>
                    <p style="margin-top: 12px;font-size: 14px;font-weight: bold;font-style: italic;"><?= $hotel->categoryName ?></p>
                </h4>
                <p style="margin: 7px 0px 7px 0px;" class="grey RTL fs12 hidden-xs"><?= $hotel->description ?></p>
                <div class="hidden-xs">
                  <div class="mt15"></div>
                </div>
                <div class="clearfix"></div>
                <div class="col-md-4 col-xs-6 col-sm-4 go-right">
                  <div class="row">
                    <div class="text-success fs18 text-left go-text-right go-right review ">
                      <b>
                      <small><?= $hotel->currency ?></small> <?= $hotel->minRate ?>
                      </b>
                    </div>
                  </div>
                </div>
