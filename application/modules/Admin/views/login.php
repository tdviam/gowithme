  ...
  <script type="text/javascript">
   ...
   <div style="position: fixed; width: 500px; height: 200px; margin: 10% auto; /* Will not center vertically and won't work in IE6/7. */ left: 0; right: 0;">
    ...
    <form role="form" class="logpanel form-forgot form-horizontal wow flipInY animated" style="display: none"  id="passresetfrm" onsubmit="return false;">
      ...
      <footer data-wow-duration="0.5s" data-wow-delay="0.5s" class="text-center wow fadeIn"><small> <p data-wow-duration="1s" data-wow-delay="1s" class="text-center wow fadeInDown" style="color:#919191;margin-bottom: 0px; text-transform: uppercase; letter-spacing: 2px;"> Powered by  <a target="_blank" style="color: #474747" href="http://phptravels.com"><b>PHPTRAVELS</b></a> <a href="http://phptravels.com/change-log/#<?php echo PT_VERSION; ?>"></a><?php echo PT_VERSION; ?></p> </small></footer>
    </div>
