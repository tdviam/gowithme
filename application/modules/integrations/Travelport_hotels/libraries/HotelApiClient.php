...
{
    // public $apiUrl       = 'https://emea.universal-api.pp.travelport.com/B2BGateway/connect/uAPI/HotelService';
    // public $publicKey    = 'Universal API/uAPI7125879126-2409afed';
    // public $secretKey    = 'tT3dQehDGqSxTQe2gjkyjnk9a';
    // public $targetBranch = 'P7004139';
    public $requestXML   = __DIR__.'/wsdl_and_schema/hotel_v42_0/Request.xml';
    public $client;
