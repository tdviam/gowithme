...
class HotelApiBack extends MX_Controller
{
	...
	public function bookings()
	{
		...
		$xcrud->multiDelUrl = base_url('admin/travelport_flight/ajaxController/delete_multiple_record');

		$xcrud->button(base_url('flight/invoice?token={access_token}'), 'View Invoice', 'fa fa-search-plus', 'btn btn-primary', array('target' => '_blank'));
